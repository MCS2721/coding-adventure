...
/* += is an addition assignment. It takes 'i = i + 2' and assigns (=) the value to the variable i. 
Then continues to increment the variable. */
...
// 'sum +=  1' is shorthand for 'sum = sum + i'
...
console.log('- - - - -');
/* Task 4:
    Division: Write a 'for' loop to divide a 'number' by 2 repeatedly until it is less than 1. */

var number = 64;
for (var i = number; i >= 1; i /= 2) {
    console.log(i);
}
console.log("The number is now less than 1");

/*
    This code displays what i would be if 'number' was divided by 2 repeatedly but never going below 1.
    '/=' is the compound assignment, specifically the division assignment.
*/
